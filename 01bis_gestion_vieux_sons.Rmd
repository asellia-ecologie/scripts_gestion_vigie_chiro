...
import datetime
from variables import USER, PASSWORD, HOST, PORT, DB_NAME, dossier 
...
# os.chdir(dossier)
os.chdir('/media/asellia_pc_chiro/T_02/02_SONS_A_TRAITER')
...
rootdir = os.getcwd()
a_classer = os.path.join(rootdir, '01b_a_classer_old')
...
### Vérification des nuits/placette avant codage vigie-chiro
```{python verif placette bdd}
...
participations = pd.read_csv(f'{a_nommer}/a_coder20231030_101340_ok_created.csv', sep = ";")
