---
title: "Création de participations Vigie Chiro"
output: html_notebook
---

Penser à faire tourner une première fois avec test = T
et à renseigner le chemin vers le csv a_coder dans FileBMRE
ensuite il suffit de cliquer sur "Play"
...
test=T #T si base de test, F si base de prod
FileBMRE="/home/asellia_pc_chiro/Bureau/GESTION_SONS/01_SONS_A_TRAITER/02_a_nommer/a_coder20231024_212431_ok.csv"
CorrRecorders=fread("Recorders_BMRE_VC.csv")
CorrMics=fread("Mics_BMRE_VC.csv")
CoordNames=c("X","Y")

if(test){
  connection_string= "mongodb://vigiechiro:dz93X8R3aCWw35xS@ccdbmgtstno01.in2p3.fr:27080,ccdbmgtstno03.in2p3.fr:27080,ccdbmgtstno02.in2p3.fr:27080/vigiechiro?replicaSet=rs1&authSource=vigiechiro&socketTimeoutMS=6000000" #base de test
}else{
...
Sys.time()
SiteLoc$longitude=as.numeric(SiteLoc$longitude)
SiteLoc$latitude=as.numeric(SiteLoc$latitude)
...
summary(ClosestN)
MissingPoints=subset(MetadataBMRE,ClosestN>40)
if(max(ClosestN)>40){
